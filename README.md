...
Inspiration from the React tic-tac-toe tutorial (https://reactjs.org/tutorial/tutorial.html). CSS for the iOS calculator from (https://medium.com/statuscode/celebrate-css-grid-support-by-re-creating-the-ios-calculator-5f2da806e96f)
